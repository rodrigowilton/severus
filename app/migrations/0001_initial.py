...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cond_nome', models.CharField(blank=True, db_comment='Nome do condomÝnio a qual o contato estß realizando o contato.', max_length=100, null=True)),
                ('contato_nome', models.CharField(blank=True, db_comment='Nome do contato que fez a prospecþÒo', max_length=100, null=True)),
                ('contato_telefone', models.CharField(blank=True, db_comment='Telefone do contato que fez a prospecþÒo.', max_length=45, null=True)),
                ('contato_email', models.CharField(blank=True, db_comment='Email do contato a qual estß realizando a prospecþÒo.', max_length=100, null=True)),
                ('contato_cargo', models.CharField(blank=True, db_comment='Cargo do contato no condomÝnio a qual estß realizando a prospecþÒo. ', max_length=45, null=True)),
                ...
                ('cond_qtd_apt', models.IntegerField(blank=True, db_comment='Quantidade de apartamento dentro do condomÝnio a qual estß realizando a prospecþÒo.', null=True)),
                ('cond_tipo_port', models.CharField(blank=True, db_comment='Tipo de portaria no condomÝnio a qual estß realizando a prospecþÒo.', max_length=45, null=True)),
                ('observacao', models.CharField(blank=True, max_length=255, null=True)),
                ('status', models.IntegerField()),
                ('created', models.DateTimeField(blank=True, null=True)),
                ('modified', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.IntegerField(blank=True, db_comment='1 - Gratuito, 2 - Aguardando Pagamento, 6  - A receber em dinheiro, 7 - A receber por Pagseguro, 8 - A receber por transferÛncia, 3 - Pago em dinheiro, 5 - Pago por Pagseguro, 4 - Pago por transferÛncia, 9 - Em Analise', null=True)),
                ...
                ('metodo_pagamento', models.IntegerField(blank=True, db_comment='1 - CartÒo de CrÚdito, 2 - Boleto, 3 - DÚbito, 4 - Saldo PagSeguro, 5 - Oi Paggo, 7 - DÚposito em conta, 11 - PIX', null=True)),
                ('link_boleto', models.TextField(blank=True, null=True)),
                ('codigo_pagseguro', models.CharField(blank=True, max_length=255, null=True)),
                ('status_pagseguro', models.IntegerField(blank=True, db_comment='1 - Aguardando Pagamento, 2 - Em analise, 3 - Paga, 4 - DisponÝvel, 5 - Em disputa, 6 - Devolvida, 7 - Cancelada, 8 - Debitado, 9 - RetenþÒo temporßria', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criticidade', models.IntegerField(blank=True, db_comment='0 - Normal; 1 - CrÝtico;', null=True)),
                ...
                ('email_send', models.IntegerField(blank=True, db_comment='1 - NÒo enviado; 2 - Enviado', null=True)),
                ('created', models.DateTimeField(blank=True, null=True)),
                ('modified', models.DateTimeField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('orcamento_nome', models.CharField(blank=True, db_comment='"ID" do orþamento', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, null=True)),
                ('modified', models.DateTimeField(blank=True, null=True)),
                ('tipos_veiculo', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.tiposveiculos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, null=True)),
                ('modified', models.DateTimeField(blank=True, null=True)),
                ('subtipos_tipos_abastecimentos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.subtipostiposabastecimentos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, null=True)),
                ('modified', models.DateTimeField(blank=True, null=True)),
                ('tattica_funcionario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.tatticafuncionarios')),
                ('tattica_veiculo', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.tatticaveiculos')),
                ('tipos_abastecimento', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='app.tiposabastecimentos')),
            ],
            options={
